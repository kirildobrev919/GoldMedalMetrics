...
const createCountryTable = () => {
  return 'CREATE TABLE Country (name	TEXT NOT NULL,' +
    'code	TEXT NOT NULL, gdp	INTEGER, population	INTEGER);';
};
...
const createGoldMedalTable = () => {
  return 'CREATE TABLE GoldMedal (id INTEGER NOT NULL UNIQUE, year INTEGER NOT NULL,'
...
const orderedMedals = (country, field, sortAscending) => {
  ...
  if (field) {
    if (sortAscending) {
      sortOption = `ORDER BY ${field} ASC`;
    } else {
      sortOption = `ORDER BY ${field} DESC`
    }
  }
